...
-The app features 4 full epics that exceed expectations, with polished features.

- The requirements are seamlessly integrated

- The app gracefully handles offline scenarios and provides clear feedback to the user.

- All features are polished and ready for user deployment!
...
- The app did not crash at all.
- It includes input validation to guide users in entering data correctly and provides direct feedback!
- While the app does not allow profile deletion, it supports all other aspects of profile management.
...
- The UX and UI are excellent, the app is welcoming to new users !
...
- The code adheres well to the MVVM pattern, allowing for easy modifications. However, some functions lack proper documentation.
- The app architecture is well structured and modular !
...
- The app reaches 80% line coverage !
- The app contains 4 E2E.
- The repo setup include code quality check with SonarCloud. To improve you could set up more advanced tools.
...
- The README is polished and includes a good description of the app. For further improvement, consider adding a GIF or image to showcase your app visually.

- The wiki is exemplary, featuring clear guidelines, epic descriptions, and a research conducted throughout the app's development.

- The architecture diagram is extremely clean and well-detailed, even including the repository.

- The Figma design is excellent, though minor deviations from the app can be observed.
...
- The team is self-sufficient and have a good team spirit !
...
Based on the above points, your intermediate grade for this milestone M3 is 5.72.
