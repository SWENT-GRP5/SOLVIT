...
class CreateRequestScreenObject(semanticProvider: SemanticsNodeInteractionsProvider) :
    ComposeScreen<CreateRequestScreenObject>(semanticsProvider = semanticProvider) {
