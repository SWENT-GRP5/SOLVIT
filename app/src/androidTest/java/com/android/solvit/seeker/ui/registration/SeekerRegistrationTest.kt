...
class SeekerRegistrationTest{
    ...
    fun displayAllcomponents(){
        composeTestRule.setContent { SeekerRegistrationScreen(viewModel = seekerViewModel, navigationActions = navigationActions) }
        ...
        composeTestRule.onNodeWithTag("savePreferencesButton").assertIsDisplayed().assertTextEquals("Save Preferences")
        ...
        composeTestRule.onNodeWithTag("exploreServicesButton").assertIsDisplayed().assertTextEquals("Continue to Explore Services")
    ...
    fun testRegistrationFailsWithMismatchedPasswords() {
        ...
        composeTestRule.onNodeWithTag("locationInput").performTextInput("123 Main St")
        composeTestRule.onNodeWithTag("passwordInput").performTextInput("password123")
        composeTestRule.onNodeWithTag("confirmPasswordInput").performTextInput("password124") // Passwords do not match
