...
class ProviderRegistrationTest{
    ...
    fun testAllComponents() {
        composeTestRule.setContent {
            ProviderRegistrationScreen(viewModel = listProviderViewModel, navigationActions = navigationActions)
        }
    ...
    fun testProviderRegistrationFailsWithMismatchedPasswords() {
        composeTestRule.setContent { ProviderRegistrationScreen(viewModel = listProviderViewModel , navigationActions = navigationActions) }
