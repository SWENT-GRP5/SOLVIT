...
val SERVICES_LIST =
    listOf(
        ...
        ServicesListItem(Services.ELECTRICIAN, R.drawable.electrician, R.drawable.ic_electrician, Electrician),
        ServicesListItem(Services.TUTOR, R.drawable.tutor, R.drawable.ic_tutor, Tutor),
        ServicesListItem(Services.EVENT_PLANNER, R.drawable.event_planner,  R.drawable.ic_event_planner, EventPlanner),
        ...
        ServicesListItem(Services.CARPENTER, R.drawable.carpenter, R.drawable.ic_carpenter, Carpenter),
        ServicesListItem(Services.PHOTOGRAPHER, R.drawable.photographer, R.drawable.ic_photographer, Photographer),
        ServicesListItem(Services.PERSONAL_TRAINER, R.drawable.personal_trainer, R.drawable.ic_personal_trainer, PersonalTrainer),
        ServicesListItem(Services.HAIR_STYLIST, R.drawable.hair_stylist, R.drawable.ic_hair_stylist, HairStylist),)
