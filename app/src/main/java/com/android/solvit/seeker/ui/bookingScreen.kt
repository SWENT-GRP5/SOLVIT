                          ...
                          Box(
                              modifier =
                                ...
                                Image(
                                    painter =
                                        painterResource(
                                            id = R.drawable.empty_profile_img), // Placeholder image
                                    contentDescription =
                                        "Plumber Image", // Content description for accessibility
                                    contentScale =
                                        ContentScale
                                            .Crop, // Scale the image to crop and fill the box
                                ...
                                Box(
                                    modifier =
                                        Modifier.align(
                                                Alignment
                                                    .BottomEnd) // Positioned at the bottom-right
              ...
              Box(
                  modifier =
                    ...
                    GoogleMap(
                        ...
                        modifier = Modifier.fillMaxSize()) // Display the map
              }
            }
      }
}
