...
fun EditProfileScreen(
    ...
    var username by remember { mutableStateOf("YANCHUI") } // Hardcoded username for now
    var email by remember { mutableStateOf(currentProfile?.email ?: "") }
    var phone by remember { mutableStateOf(currentProfile?.phone ?: "") }
    var address by remember { mutableStateOf("Chemin des Triaudes") } // Hardcoded address for now
