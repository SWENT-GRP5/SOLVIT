...
class NotificationsViewModel(private val repository: NotificationsRepository) : ViewModel() {
        ...
        val Factory: ViewModelProvider.Factory =
            object : ViewModelProvider.Factory {
                ...
                override fun <T : ViewModel> create(modelClass: Class<T>): T {
                    return NotificationsViewModel(NotificationsRepositoryFirestore(Firebase.firestore))
                            as T
                }
            }
    }
    ...
    fun sendNotifications(serviceRequest: ServiceRequest,
                          providers: List<Provider>,
                        ){

        repository.sendNotification(serviceRequest,providers,onSuccess={getNotifications(providerId)},onFailure={})
    }
}