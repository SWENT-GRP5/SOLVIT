      ...
      content = { padding ->
        Column(
            ...
            verticalArrangement = Arrangement.Top) {
              ...
              val okNewCompanyName = newCompanyName.length >= 2

              var newProfession by remember { mutableStateOf(provider.service) }
              val okNewProfession = true
              ...
              var newLocation by remember { mutableStateOf(provider.location.name) }
              val okNewLocation = true
              var showDropdown by remember { mutableStateOf(false) }
              val locationSuggestions by
                  locationViewModel.locationSuggestions.collectAsState(
                      initial = emptyList<Location?>())
              var selectedLocation by remember { mutableStateOf<Location?>(null) }

              val allIsGood = okNewCompanyName && okNewProfession && okNewPhoneNumber
              ...
              CustomOutlinedTextField(
                  ...
                  testTag = "providerNameInputField",
              ...
              ServiceDropdownMenu(
                  selectedService = newProfession, onServiceSelected = { newProfession = it })
              ...
              Text(
                  text = "Don't forget to save your changes by clicking on the button!",
